...
THREEx.ProceduralCity = function() {
  ...
  for (var i = 0; i < 100; i++) {
    ...
    buildingMesh.position.x = Math.floor(Math.random() * 20 - 10) * 20;
    buildingMesh.position.z = -5 + Math.floor(Math.random() * 20 - 10) * 2;
    buildingMesh.position.y = -30;
  ...
  // cityGeometry = new THREE.BufferGeometry().fromGeometry(cityGeometry);
  // cityGeometry.vertices.forEach(v => {
  //   let vt = new THREE.Vector3(v.x, v.y + 10, v.z);
  //   cityGeometry.morphTargets.push(vt);
  // });
